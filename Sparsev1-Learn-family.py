...
for epoch in range(num_iters):
    ...
    if epoch % 49 == 0 and epoch>0 :
        print('epoch {} before_decoder'.format(epoch), [torch.round(100*valuation[i])/100. for i in range(num_predicates)])
